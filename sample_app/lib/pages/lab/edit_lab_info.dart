...
class EditLabInfo extends StatelessWidget {
  const EditLabInfo({Key? key}) : super(key: key);
...
class FormScreenState extends State<FormWidget> {
  ...
  Widget _buildLabName() {
    return TextFormField(
      initialValue:
          Provider.of<CurrentUser>(context, listen: false).object.name,
      readOnly: true,
      decoration:
          InputDecoration(labelText: 'Lab Name', border: InputBorder.none),
    );
  }
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    if (!_formKey.currentState!.validate()) {
                      ...
                      // print(Provider.of<CurrentUser>(context).object.city);
